      ...
      <div className="max-w-3xl"> {/* Using max-w-3xl as per the example structure for this slide */}
        ...
        <div className="max-w-2xl mx-auto text-center"> {/* Adjusted width and centering for this section */}
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8"> {/* Increased bottom margin */}
            How data usually flows: from local devices up to big cloud servers.
          </p>
          <div className="space-y-6 text-lg"> {/* Increased space between hierarchy items */}
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg bg-white dark:bg-gray-800">
              <h3 className="text-2xl font-semibold text-blue-600 dark:text-blue-400 mb-2">1. Edge Layer (Local Devices)</h3>
              <p className="text-gray-700 dark:text-gray-300">Where data is born (sensors, phones). Handles quick tasks & filters data on the spot.</p>
              <p className="text-3xl mt-3 text-gray-400 dark:text-gray-500">⬇️</p>
            </div>
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg bg-white dark:bg-gray-800">
              <h3 className="text-2xl font-semibold text-green-600 dark:text-green-400 mb-2">2. Fog Layer (Nearby Network)</h3>
              <p className="text-gray-700 dark:text-gray-300">Connects Edge to Cloud. Manages local data, helps speed up regional tasks.</p>
              <p className="text-3xl mt-3 text-gray-400 dark:text-gray-500">⬇️</p>
            </div>
            <div className="p-6 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg bg-white dark:bg-gray-800">
              <h3 className="text-2xl font-semibold text-purple-600 dark:text-purple-400 mb-2">3. Cloud Layer (Big Servers)</h3>
              <p className="text-gray-700 dark:text-gray-300">Stores and processes lots of data, runs big apps, and manages services globally.</p>
            </div>
          </div>
          <p className="text-md text-gray-500 dark:text-gray-400 mt-10"> {/* Adjusted text size and margin */}
            This setup helps everything run faster and smoother by using the best layer for each task.
          </p>
        </div>

        <div className="text-sm text-gray-500 dark:text-gray-400 mt-12">
          {/* Changed footer text */}
          <p>Layers working together for best results.</p>
        </div>
      </div>
    </div>
  );
